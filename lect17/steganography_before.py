...
def hide_bits(hat_value, bunny_value, n=4):
    ...
    """
    hat_clear = (hat_value >> n) << n # n = 0xA0
    bunny_clear = bunny_value >> n  # 0x0C
    
    return hat_clear | bunny_clear
